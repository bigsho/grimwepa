...
if [ $1 ]; then
	...
	if [ $1 = "install" ]; then
		...
		echo "[!] Save this grimstall.sh file if you wish to uninstall GrimWepa in the future."
...
echo "[?] Usage: ./grimstall.sh [install/remove]"
echo ""
echo "[?] To install GrimWepa to your system, "
echo "    run this grimstall.sh file in the same "
echo "    directory as ${FILE} with this argument:"
echo "./grimstall.sh install"
echo ""
echo "[?] To remove GrimWepa from your system, "
echo "    run this grimstall.sh file with 'remove' as an argument:"
echo "./grimstall.sh remove"
